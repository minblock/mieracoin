# Support for Output Descriptors in Mieracoin Core

Since Mieracoin Core v0.17, there is support for Output Descriptors. This is a
...
on Mieracoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Mieracoin Core wallets, a convenience function `combo` is
