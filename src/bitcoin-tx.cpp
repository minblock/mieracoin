...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mieracoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mieracoin-tx [options] <hex-tx> [commands]  Update hex-encoded mieracoin transaction\n" +
            "or:     mieracoin-tx [options] -create [commands]   Create hex-encoded mieracoin transaction\n" +
            "\n";
