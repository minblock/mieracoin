...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585900243, 1131710, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x769ab7cc5568850526bdb209de20daabcbb44292f30c1801e02459e41116e78d"));
        ...
        vSeeds.emplace_back("seed-a.mieracoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.mieracointools.com");
        vSeeds.emplace_back("dnsseed.mieracoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.mieracointools.com");
        vSeeds.emplace_back("seed-b.mieracoin.loshan.co.uk");
