...
"""Verify that starting mieracoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mieracoin with -h for help text")
        ...
        self.log.info("Start mieracoin with -version for version information")
        ...
        self.log.info("Start mieracoind with -fakearg to make sure it does not start")
